...
export const FileUploadArea: FunctionComponent<{addJudge: Function}> = ({addJudge}) => {
    ...
    allJudgesArray.push({_id: "REFRESH TO SEE", name: name, email: email, evaluations: [], totalEarnedPoints: 0,
    ...
    return (<div>
        <div>Upload Judges from File: <input onChange={(e: any)=> processFile(e.target.files[0])} accept={".csv"}
            type={'file'}></input></div>
